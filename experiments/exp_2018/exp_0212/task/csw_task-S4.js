...
var intro5 = {
	...
	var q_4 = {
		type: 'html-keyboard-response',
		stimulus: '<p> What happens next? <p>',
		labels: ['Nick was extremely annoyed and said, \"Excuse me?!\"', 'Nick promptly stepped back in front of Ben.'],
		choices: ['leftarrow', 'rightarrow'],
		data: { state_info: 'q_4_CutlineStepinfront_CutlineSayexcuseme_70_Default_10' }
	} 
	var s_5 = {
		type: 'instructions',
	...
	var q_8 = {
		...
		choices: ['leftarrow', 'rightarrow'],
		data: { state_info: 'q_8_SubjectstaresSayrelax_SubjectstaresXshove_66_Default_10' }
	} 
	var s_9 = {
		type: 'instructions',
	...
	var q_10 = {
		...
		choices: ['leftarrow', 'rightarrow'],
		data: { state_info: 'q_10_SayrelaxCreamsplash_SayrelaxCreamsplash_100_Permute_10' }
	} 
	var s_11 = {
		type: 'instructions',
	...
	var q_16 = {
		...
		choices: ['leftarrow', 'rightarrow'],
		data: { state_info: 'q_16_HatecoffeeEND_HatecoffeeEND_100_Alter_01' }
	} 
	var s_17 = {
		type: 'instructions',
	...
	var q_23 = {
		...
		choices: ['leftarrow', 'rightarrow'],
		data: { state_info: 'q_23_StepinfrontIgnore_StepinfrontSubjectstares_16_Default_01' }
	} 
	var s_24 = {
		type: 'instructions',
	...
	var q_25 = {
		...
		choices: ['leftarrow', 'rightarrow'],
		data: { state_info: 'q_25_IgnoreXstare_IgnoreSayrelax_66_Default_01' }
	} 
	var s_26 = {
		type: 'instructions',
		pages: ['Nick stared with rage into Silvia\'s eyes.'],
		data: { state_info: 's_26_Xstare' }
	} 
	var s_27 = {
		type: 'instructions',
		pages: ['Silvia picked up a small cup of cream and splashed it in Nick\'s face.'],
		data: { state_info: 's_27_Creamsplash' }
	} 
	var q_28 = {
		type: 'html-keyboard-response',
		stimulus: '<p> What happens next? <p>',
		...
		choices: ['leftarrow', 'rightarrow'],
		data: { state_info: 'q_28_CreamsplashCallpoliceman_CreamsplashCallpoliceman_100_Alter_10' }
	} 
	var s_29 = {
		type: 'instructions',
		pages: ['Olivia, the police officer, ordered Silvia to leave before anyone pressed charges.'],
		data: { state_info: 's_29_Callpoliceman' }
	} 
	var q_30 = {
		type: 'html-keyboard-response',
		stimulus: '<p> What happens next? <p>',
		...
		choices: ['leftarrow', 'rightarrow'],
		data: { state_info: 'q_30_CallpolicemanLovejuice_CallpolicemanLovejuice_100_Alter_01' }
	} 
	var s_31 = {
		type: 'instructions',
...
betweenstory_18,s_19,q_20,s_21,s_22,q_23,s_24,q_25,s_26,s_27,q_28,s_29,q_30,s_31,q_32,s_33,
betweenstory_34,],
